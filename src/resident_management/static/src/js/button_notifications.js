odoo.define('resident_management.button_notifications', function (require) {
    "use strict";
    ...
    var perm_create = rpc.query({
                                    ...
                                    args: ["perm_create_notification"],
                                });
    var perm_delete = rpc.query({
                                    model: 'res.users',
                                    method: 'check_perm_user',
                                    args: ["perm_delete_notification"],
                                });
    var perm_write = rpc.query({
                                    model: 'res.users',
                                    method : 'check_perm_user',
                                    args: ["perm_write_notification"],
                                });
    var perm_approve = rpc.query({
                                    model: 'res.users',
                                    method : 'check_perm_user',
                                    args: ["perm_approve_notification"],
                                });
    ...
    viewRegistry.add('tree_action_notifications', AdminUserListView);
    ...
    viewRegistry.add('form_action_notifications', FormActionView);
