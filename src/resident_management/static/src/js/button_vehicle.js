odoo.define('resident_management.button_vehicle', function (require) {
    "use strict";
    ...
    var perm_create = rpc.query({
                                    ...
                                    args: ["perm_create_vehicle"],
                                });
    var perm_delete = rpc.query({
                                    model: 'res.users',
                                    method: 'check_perm_user',
                                    args: ["perm_delete_vehicle"],
                                });
    var perm_write = rpc.query({
                                    model: 'res.users',
                                    method : 'check_perm_user',
                                    args: ["perm_write_vehicle"],
                                });
    var perm_approve = rpc.query({
                                    model: 'res.users',
                                    method : 'check_perm_user',
                                    args: ["perm_approve_vehicle"],
                                });
    ...
    viewRegistry.add('tree_action_vehicle', AdminUserListView);
    ...
    viewRegistry.add('form_action_vehicle', FormActionView);
