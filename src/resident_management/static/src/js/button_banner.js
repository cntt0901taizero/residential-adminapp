odoo.define('resident_management.button_banner', function (require) {
    "use strict";
    ...
    var perm_create = rpc.query({
                                    ...
                                    args: ["perm_create_advertisement"],
                                });
    var perm_delete = rpc.query({
                                    model: 'res.users',
                                    method: 'check_perm_user',
                                    args: ["perm_delete_advertisement"],
                                });
    var perm_write = rpc.query({
                                    model: 'res.users',
                                    method : 'check_perm_user',
                                    args: ["perm_write_advertisement"],
                                });
    var perm_approve = rpc.query({
                                    model: 'res.users',
                                    method : 'check_perm_user',
                                    args: ["perm_approve_advertisement"],
                                });
    ...
    viewRegistry.add('tree_action_banner', AdminUserListView);
    ...
    viewRegistry.add('form_action_banner', FormActionView);
