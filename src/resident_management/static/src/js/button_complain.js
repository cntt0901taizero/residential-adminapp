odoo.define('resident_management.button_complain', function (require) {
    "use strict";
    ...
    var perm_create = rpc.query({
                                    ...
                                    args: ["perm_create_complain"],
                                });
    var perm_delete = rpc.query({
                                    model: 'res.users',
                                    method: 'check_perm_user',
                                    args: ["perm_delete_complain"],
                                });
    var perm_write = rpc.query({
                                    model: 'res.users',
                                    method : 'check_perm_user',
                                    args: ["perm_write_complain"],
                                });
    var perm_approve = rpc.query({
                                    model: 'res.users',
                                    method : 'check_perm_user',
                                    args: ["perm_approve_complain"],
                                });
    ...
    viewRegistry.add('tree_action_complain', AdminUserListView);
    ...
    viewRegistry.add('form_action_complain', FormActionView);
