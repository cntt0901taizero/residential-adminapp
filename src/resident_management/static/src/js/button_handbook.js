odoo.define('resident_management.button_handbook', function (require) {
    "use strict";
    ...
    var perm_create = rpc.query({
                                    ...
                                    args: ["perm_create_handbook"],
                                });
    var perm_delete = rpc.query({
                                    model: 'res.users',
                                    method: 'check_perm_user',
                                    args: ["perm_delete_handbook"],
                                });
    var perm_write = rpc.query({
                                    model: 'res.users',
                                    method : 'check_perm_user',
                                    args: ["perm_write_handbook"],
                                });
    var perm_approve = rpc.query({
                                    model: 'res.users',
                                    method : 'check_perm_user',
                                    args: ["perm_approve_handbook"],
                                });
    ...
    viewRegistry.add('tree_action_handbook', AdminUserListView);
    ...
    viewRegistry.add('form_action_handbook', FormActionView);
