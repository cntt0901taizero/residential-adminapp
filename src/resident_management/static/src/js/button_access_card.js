odoo.define('resident_management.button_access_card', function (require) {
    "use strict";
    ...
    var perm_create = rpc.query({
                                    ...
                                    args: ["perm_create_access_card"],
                                });
    var perm_delete = rpc.query({
                                    model: 'res.users',
                                    method: 'check_perm_user',
                                    args: ["perm_delete_access_card"],
                                });
    var perm_write = rpc.query({
                                    model: 'res.users',
                                    method : 'check_perm_user',
                                    args: ["perm_write_access_card"],
                                });
    var perm_approve = rpc.query({
                                    model: 'res.users',
                                    method : 'check_perm_user',
                                    args: ["perm_approve_access_card"],
                                });
    ...
    viewRegistry.add('tree_action_access_card', AdminUserListView);
    ...
    viewRegistry.add('form_action_access_card', FormActionView);
