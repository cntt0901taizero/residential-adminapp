...

{
    ...
    'data': [
        ...
        'views/apartment_utilities_approve_view.xml',
        'views/vehicle_view.xml',
        'views/vehicle_approve_view.xml',
        'views/access_card_view.xml',
        'views/access_card_approve_view.xml',
        'views/complain_approve_view.xml',
        'views/complain_view.xml',
        'views/register_delivery_view.xml',
        'views/register_delivery_approve_view.xml',
        'views/resident_handbook_view.xml',
        'views/resident_handbook_approve_view.xml',
    ],
    'installable': True,
    'auto_install': True,
}
